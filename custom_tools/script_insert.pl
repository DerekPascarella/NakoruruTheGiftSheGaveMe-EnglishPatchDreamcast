...
# scd_25_b_(119).
elsif($script_file =~ /scd_25_b_\(119\)/)
{
	$full_file_hex =~ s/82AE82B0829F82B782A382B082B282A382B682B282D882D6/8260826182638264826582668267826982D882D6/gi;
}
# Add dialogue text to Nakoruru's voiced line at the end of scd_49_b_(256).
elsif($script_file =~ /scd_49_b_\(256\)/)
{
	$full_file_hex =~ ;
}
# For dramatic effect, force all text to render during Yantamu's death scene in scd_49_a_(255).
elsif($script_file =~ /scd_49_a_\(255\)/)
{
	$full_file_hex =~ ;
}

# Fix prompts that use the "mic 000" control code.
if($full_file_hex =~ /6D696320303030/i)
{
	# Status message.
	print " -> Changed \"mic 000\" control code to \"mih 000\".\n";

	$full_file_hex =~ s/6D696320303030/6D696820303030/gi;
	$full_file_hex =~ s/6D6968203030300D0A6D696820303030/6D696820303030/gi;
}

# Fix broken newlines missing leading 0x0D byte, or trailing 0x0A byte.
my @hex_data_array = (uc($full_file_hex) =~ m/../g);
my @hex_data_array_new = @hex_data_array;
my $broken_newline_count = 0;

for(my $i = 1; $i < scalar(@hex_data_array); $i ++)
{
	if($hex_data_array[$i] eq "0A" && $hex_data_array[$i - 1] ne "0D")
	{
		splice(@hex_data_array_new, $i + $broken_newline_count, 0, "0D");

		$broken_newline_count ++;
	}
	elsif($hex_data_array[$i] eq "0D" && $hex_data_array[$i + 1] ne "0A")
	{
		splice(@hex_data_array_new, $i + $broken_newline_count, 0, "0A");

		$broken_newline_count ++;
	}
}

# One or more broken newlines were fixed.
if($broken_newline_count > 0)
{
	# Store fixed hex data.
	$full_file_hex = join("", @hex_data_array_new);

	# Status message.
	print " -> Broken newlines fixed: $broken_newline_count.\n";
}
...
sub generate_hex
{
	...
	# Don't process optimized combined italics for three exclamation marks (!!!) if using italic font.
	if($char_map ne "chars_italic.txt")
	{
		$input =~ s/\!\!\!/\*/g;
		$input =~ s/\*/\*\*/g;
	}
	...
	for(my $i = 0; $i < scalar(@folded_text_array); $i ++)
	{
		...
		for(my $m = 0; $m < scalar(@folded_chars); $m ++)
		{
			...
			if($folded_chars[$m] eq "#" || $folded_chars[$m] eq "^" || $folded_chars[$m] eq "&" || $folded_chars[$m] eq "*")
			{
				$char_count += 2;
			}
