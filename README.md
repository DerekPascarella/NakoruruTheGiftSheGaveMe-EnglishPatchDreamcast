...
<ul>
 ...
 <li>Rewrote and optimized code in the functions responsible for pushing icon data to VMU LCD, thus eliminating an issue causing intermittent ignored input (i.e., button presses) on the <a href="http://www.dreammods.net/dreamconn.html">DreamConn+</a> controller (read more in <a href="https://www.dreamcast-talk.com/forum/viewtopic.php?f=52&t=14736&p=171379#p171379">this Dreamcast-Talk.com forum post</a>).</li>
